...
export default function CallToAction() {
  return (
    <div className="w-full rounded-xl lg:my-10 xl:my-20 h- bg-[url('/assets/imgs/cta-bg.svg')] bg-cover bg-center">
      <div className="max-w-3xl p-4 mx-auto text-center md:py-8 lg:py-16">
        ...
        <div className="flex flex-col md:flex-row justify-center md:gap-4 py-3 md:py-5 items-center align-center">
          <Input
